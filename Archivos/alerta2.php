...
<center><table>
			...
			<tr>
<td><center><form action=alerta.php><input type=submit name=boton value="Filtrar 20"></form></center></td>
<td><center><form action=alerta3.php><input type=submit name=boton value="Filtrar 60"></form></center></td>
<td><center><form action=alerta4.php><input type=submit name=boton value="Filtrar 100"></form></center></td>
<td><center><form action=alerta5.php><input type=submit name=boton value="Filtrar 200"></form></center></td>
<td><center><form action=alerta6.php><input type=submit name=boton value="Filtrar 300"></form></center></td>
</tr>
</table></center>
		</div>
...
<meta http-equiv=Refresh content="6;url=alerta2.php">
