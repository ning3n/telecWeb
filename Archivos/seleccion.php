...
<tr>
<td colspan=2><center><input type=hidden name=id value="<?php echo $primary_device_id; ?>"><input type=submit value=CONTINUAR></center></td>
</tr>
</table>
</form>
</div>
