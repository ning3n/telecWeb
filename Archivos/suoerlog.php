...
$DB=$misN;
	...
	mysql_select_db($DB,$conex) or die ("Database selection troubles");
...
<input type=hidden name=password value="<?php echo $password;?>"><input type=submit value="Add Cli">
 ...
 <form action=stats.php method=post><input type=hidden name=paracostos value="<?php echo $paracostos;?>">
<input type=hidden name=password value="<?php echo $password;?>"><input type=submit value="Stats">
</form>
<form action=disasign.php method=post><input type=hidden name=paracostos value="<?php echo $username;?>">
<input type=hidden name=password value="<?php echo $password;?>"><input type=submit value="Dispositivos">
</form>
<form action=index_en.php method=post><input type=hidden name=paracostos value="<?php echo $paracostos;?>">
<input type=hidden name=password value="<?php echo $password;?>"><input type=submit value="Close">
		...
		<center>
<p align="right">
<span>Cambiar idioma:</span>  &nbsp; <a href=superlog.php><img src="pictures/bandera2.png" width="30" height="25"></a>
</p>
...
<div id="titulo">
<?php echo"<h3><b>Welcome to Intercom: ".$username."<br>"." BALANCE: " .round($cos,0)."</b></h3>"; ?>
...
<thead>
				<tr class="centro">
					...
					<td bgcolor=#484848>Test numbers</td>
