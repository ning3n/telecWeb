...
<input type=hidden name=password value="<?php echo $password;?>"><input type=submit value="Principal">
 ...
 <form action=listado.php method=post><input type=hidden name=user value="<?php echo $username;?>">
...
<p align="right">
<?php echo"<b>SALDO: " .round($cos,0)."</b>"; ?>
...
echo"<meta http-equiv=Refresh content=6;url=superlog.php>";
?>
