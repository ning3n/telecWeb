...
<center><table>
			...
			<tr>
<td><center><form action=alerta.php><input type=submit name=boton value="Filtrar 20"></form></center></td><td><center><form action=alerta3.php><input type=submit name=boton value="Filtrar 60"></form></center></td>
</tr>
</table></center>
		</div>
