...
<tr>
<td colspan=5><center><input type=hidden name=id value="<?php echo $id; ?>"><input type=hidden name=cantidad value="<?php echo $cantidad; ?>"><input type=submit value=CONTINUE></center></td>
</tr>
</table>
</form>
</div>
